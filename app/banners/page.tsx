...
export default function Banner() {
  ...
  // Queries
  const { data: bannersResponse, isLoading: bannersLoading, error: bannersError } = useQuery<IServiceResponse<IBanner[]>, Error>({
    queryKey: ['banners'],
  ...
  const banners = bannersResponse?.responseObject || [];
              ...
              <TableBody>
                {banners.map((banner: IBanner, index: number) => (
                  <TableRow key={banner.id}>
                    ...
                    <TableCell>{banner.carId}</TableCell>
